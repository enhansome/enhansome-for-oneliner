...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,671 | 🐛 106 | 📅 2026-09-02
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,590 | 🐛 480 | 🌐 C | 📅 2026-09-01 - A JSON Query Language tool
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,030 | 🐛 25 | 🌐 Go | 📅 2026-08-16 - Query and update data structures using selectors from the command line. Comparable to [jq](https://github.com/stedolan/jq) ⭐ 35,590 | 🐛 480 | 🌐 C | 📅 2026-09-01 - [yq](https://github.com/kislyuk/yq) ⭐ 2,975 | 🐛 23 | 🌐 Python | 📅 2026-07-11 but supports JSON, YAML, TOML and XML with zero runtime dependencies.
* [jo](https://github.com/jpmens/jo) ⭐ 4,863 | 🐛 7 | 🌐 C | 📅 2025-06-20 - A small utility to create JSON objects from command-line arguments
* [gojq](https://github.com/itchyny/gojq) ⭐ 3,804 | 🐛 19 | 🌐 Go | 📅 2026-09-13 -A JSON Query Language tool written in Go
* [jql](https://github.com/yamafaktory/jql) ⭐ 1,679 | 🐛 0 | 🌐 Rust | 📅 2026-09-08 - A JSON Query Language tool written in Rust
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,226 | 🐛 194 | 🌐 Rust | 📅 2026-08-04 - recursively searches directories for a regex pattern while respecting your gitignore. (The name of command: `rg`)
...
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,290 | 🐛 11 | 🌐 C++ | 📅 2026-08-31 - a faster, more user-friendly and more featureful replacement for grep (The name of command: `ug`)
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,438 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - A rewrite of cat with paging, syntax highlighting, and line numbers
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,293 | 🐛 232 | 🌐 Go | 📅 2026-09-07 - A command-line markdown viewer/renderer
* [rich-cli](https://github.com/Textualize/rich-cli) ⭐ 3,722 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Syntax-highlights files from the command line
...
* [pandoc](https://github.com/jgm/pandoc) ⭐ 46,260 | 🐛 1,040 | 🌐 Haskell | 📅 2026-09-13 - Universal markup converter written in Haskell
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,490 | 🐛 40 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, convert and manipulate colors

## Image Processing

* [textimg](https://github.com/jiro4989/textimg) ⭐ 262 | 🐛 9 | 🌐 Go | 📅 2026-09-13 - Command to convert from color text (ANSI or 256) to image
...
* [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,610 | 🐛 186 | 📅 2025-08-28
* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,381 | 🐛 0 | 🌐 Shell | 📅 2026-09-13
