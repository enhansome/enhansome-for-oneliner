...
* [sd](https://github.com/chmln/sd) ⭐ 7,347 | 🐛 78 | 🌐 Rust | 📅 2026-02-25 - Intuitive find & replace CLI (sed alternative)
* [sad](https://github.com/ms-jpq/sad) ⭐ 2,044 | 🐛 28 | 🌐 Rust | 📅 2026-05-11 - sed replacement written in Rust

## Grep Replacement

* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,129 | 🐛 191 | 🌐 Rust | 📅 2026-08-04 - recursively searches directories for a regex pattern while respecting your gitignore. (The name of command: `rg`)
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,349 | 🐛 200 | 🌐 Rust | 📅 2026-09-09 - A simple, fast and user-friendly alternative to `find`

## Cat Replacement

* [bat](https://github.com/sharkdp/bat) ⭐ 60,392 | 🐛 514 | 🌐 Rust | 📅 2026-09-04 - A rewrite of cat with paging, syntax highlighting, and line numbers
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,238 | 🐛 230 | 🌐 Go | 📅 2026-09-07 - A command-line markdown viewer/renderer
...
* [pandoc](https://github.com/jgm/pandoc) ⭐ 46,204 | 🐛 1,035 | 🌐 Haskell | 📅 2026-09-09 - Universal markup converter written in Haskell
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,485 | 🐛 40 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, convert and manipulate colors
...
* [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,582 | 🐛 184 | 📅 2025-08-28
* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,352 | 🐛 1 | 🌐 Shell | 📅 2026-09-05
