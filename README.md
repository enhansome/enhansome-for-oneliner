...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,206 | 🐛 193 | 🌐 Rust | 📅 2026-08-04 - recursively searches directories for a regex pattern while respecting your gitignore. (The name of command: `rg`)
...
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,286 | 🐛 10 | 🌐 C++ | 📅 2026-08-31 - a faster, more user-friendly and more featureful replacement for grep (The name of command: `ug`)

## Find Replacement

* [fd](https://github.com/sharkdp/fd) ⭐ 44,383 | 🐛 204 | 🌐 Rust | 📅 2026-09-09 - A simple, fast and user-friendly alternative to `find`

## Cat Replacement

* [bat](https://github.com/sharkdp/bat) ⭐ 60,429 | 🐛 515 | 🌐 Rust | 📅 2026-09-04 - A rewrite of cat with paging, syntax highlighting, and line numbers
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,280 | 🐛 231 | 🌐 Go | 📅 2026-09-07 - A command-line markdown viewer/renderer
...
* [pandoc](https://github.com/jgm/pandoc) ⭐ 46,250 | 🐛 1,042 | 🌐 Haskell | 📅 2026-09-11 - Universal markup converter written in Haskell
...
* [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,605 | 🐛 185 | 📅 2025-08-28
* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,375 | 🐛 3 | 🌐 Shell | 📅 2026-09-05
