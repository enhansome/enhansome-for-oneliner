...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,233 | 🐛 106 | 📅 2026-09-02
...
[Open USP Tsukubai](https://github.com/usp-engineers-community/Open-usp-Tukubai) ⭐ 140 | 🐛 1 | 🌐 Python | 📅 2026-08-11 - Unix-style commands for corporate systems written in Python
...
* [sd](https://github.com/chmln/sd) ⭐ 7,344 | 🐛 78 | 🌐 Rust | 📅 2026-02-25 - Intuitive find & replace CLI (sed alternative)
* [sad](https://github.com/ms-jpq/sad) ⭐ 2,046 | 🐛 28 | 🌐 Rust | 📅 2026-05-11 - sed replacement written in Rust

## Grep Replacement

* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,977 | 🐛 185 | 🌐 Rust | 📅 2026-08-04 - recursively searches directories for a regex pattern while respecting your gitignore. (The name of command: `rg`)
* [the\_silver\_searcher](https://github.com/ggreer/the_silver_searcher) ⭐ 27,118 | 🐛 564 | 🌐 C | 📅 2024-06-16 - A code searching tool similar to ack, with a focus on speed. (The name of command: `ag`)
* [ugrep](https://github.com/Genivia/ugrep) ⭐ 3,271 | 🐛 9 | 🌐 C++ | 📅 2026-08-31 - a faster, more user-friendly and more featureful replacement for grep (The name of command: `ug`)

## Find Replacement

* [fd](https://github.com/sharkdp/fd) ⭐ 44,320 | 🐛 202 | 🌐 Rust | 📅 2026-09-02 - A simple, fast and user-friendly alternative to `find`

## Cat Replacement

* [bat](https://github.com/sharkdp/bat) ⭐ 60,373 | 🐛 424 | 🌐 Rust | 📅 2026-09-04 - A rewrite of cat with paging, syntax highlighting, and line numbers
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,194 | 🐛 230 | 🌐 Go | 📅 2026-09-02 - A command-line markdown viewer/renderer
* [rich-cli](https://github.com/Textualize/rich-cli) ⭐ 3,715 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Syntax-highlights files from the command line
...
* [pandoc](https://github.com/jgm/pandoc) ⭐ 46,150 | 🐛 1,033 | 🌐 Haskell | 📅 2026-09-05 - Universal markup converter written in Haskell
...
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,485 | 🐛 39 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, convert and manipulate colors

## Image Processing

* [textimg](https://github.com/jiro4989/textimg) ⭐ 262 | 🐛 8 | 🌐 Go | 📅 2026-08-25 - Command to convert from color text (ANSI or 256) to image
...
* [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,565 | 🐛 184 | 📅 2025-08-28
* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,321 | 🐛 1 | 🌐 Shell | 📅 2026-09-02
